        ...
        <div class="col-md-10" style="float: right;">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    @endif
                    {{ Form::open(['route' => ['adminBlocksTranslate', $block->id], 'method' => 'put', 'files' => true]) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-controls">
                                ...
                                @elseif ($block->language == 'vi')
                                    Tiếng Anh <img style="height: 34px" src="{{ asset('img/home/english.jpg') }}">
                                @endif
                                <input type="hidden" name="language" value="{{ $block->language == 'en' ? 'vi' : 'en' }}">
                            </div>
                        </div>
