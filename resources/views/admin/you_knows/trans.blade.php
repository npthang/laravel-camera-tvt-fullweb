    ...
    <div class="row">
        <div class="col-md-10" style="float: right;">
            <div class="panel panel-default">
                <div class="panel-heading">Translate Co The Ban Chua Biet</div>
                <div class="panel-body">
                    ...
                    @endif
                    {{ Form::open(['route' => ['adminYou_knowsTranslate', $you_know->id], 'method' => 'put']) }}
