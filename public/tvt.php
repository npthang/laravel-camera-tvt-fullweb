 ...
 * @var string
 */
if (!defined('SECRET_ACCESS_TOKEN')) define('SECRET_ACCESS_TOKEN', 'deploying');
 ...
 * @var string
 */
if (!defined('REMOTE_REPOSITORY')) define('REMOTE_REPOSITORY', 'git@bitbucket.org:novaio/tvt.git');
 ...
 */
if (!defined('TARGET_DIR')) define('TARGET_DIR', '/var/www/tvt');
